...
            # Note: We use a custom type 'transfer_out' to distinguish from 'purchase' in deduct_wallet,
            # so let's define a new helper or modify deduct_wallet's call to reflect type 'transfer_out'.
            # For now, we will stick to 'purchase' and rely on the note/reference.
            deduct_wallet(
                current_user.wallet, 
                amount, 
...
# ----------------- NEW Client Service Routes (Fixing BuildError) -----------------
